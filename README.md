...
## exceptions
* Resolving a file path in FireSim cannot be done via `ucb.bar/firesim/docs` (for example) due to potential confusion between a directory/file name with a repo name. For this to work, you need to use `ucb.bar/firesim/firesim/<your file path>`
